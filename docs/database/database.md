...
erDiagram
    ...
    notifications {
        ...
        varchar patient_cpf ""
        varchar patient_birth_date ""
        varchar patient_gender ""
        varchar patient_race_color ""
        varchar patient_education_level ""
        varchar patient_sus_card_number ""
        varchar patient_birth_city ""
        varchar patient_current_address
